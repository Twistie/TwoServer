...
namespace test
{
    ...
    /// <summary>
    ///This is a test class for ColorDrawTest and is intended
    ///to contain all ColorDrawTest Unit Tests
    ///</summary>
    [TestClass()]
    public class ColorDrawTest
    {
        ...
        {
            ColorDraw target = new ColorDraw(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for ColorDraw Constructor
        ///</summary>
        [TestMethod()]
        public void ColorDrawConstructorTest()
        {
            ColorDraw target = new ColorDraw();
